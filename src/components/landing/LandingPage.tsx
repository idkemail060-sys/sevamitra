...
import { INITIAL_SERVICES, store } from '../../services/store';
import {
  ShieldCheck,
  Scale,
  Sparkles,
      ...
      <section className="relative overflow-hidden pt-10 sm:pt-16 pb-12 sm:pb-20 border-b border-slate-200/80 bg-gradient-to-b from-emerald-50/50 via-white to-slate-50/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto space-y-6">
            ...
            {/* CTA Buttons - Context-aware based on active authentication */}
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
              {currentUser ? (
                currentUser.role === 'WORKER' ? (
                  <button
                    onClick={() => onNavigate('/worker/dashboard')}
                    className="w-full sm:w-auto px-6 py-3.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-sm shadow-md transition flex items-center justify-center gap-2 group cursor-pointer"
                  >
                  ...
                  <>
                    ...
                    <button
                      ...
                      className="w-full sm:w-auto px-6 py-3.5 rounded-xl bg-white hover:bg-slate-50 text-slate-800 font-bold text-sm border border-slate-300 shadow-xs transition flex items-center justify-center gap-2 cursor-pointer"
                    >
                ...
                <>
                  ...
                  <button
                    ...
                    className="w-full sm:w-auto px-5 py-3.5 rounded-xl bg-slate-900 hover:bg-slate-800 text-white font-semibold text-sm shadow-xs transition flex items-center justify-center gap-2 cursor-pointer"
                  >
