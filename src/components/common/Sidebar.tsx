...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <>
      ...
      <div className="lg:hidden w-full bg-white border-b border-slate-200 px-3 py-2 overflow-x-auto flex items-center gap-1.5 scrollbar-none shadow-2xs sticky top-23 z-30">
        {navItems.map((item) => {
