...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <>
      {/* Mobile & Tablet Horizontal Scroll Navigation Bar (Optimized for all screen sizes) */}
      <div className="lg:hidden w-full shrink-0 bg-white border-b border-slate-200 px-3 py-2 overflow-x-auto flex items-center gap-1.5 scrollbar-none shadow-xs sticky top-0 z-20">
        {navItems.map((item) => {
          ...
          return (
            <button
              ...
              className={`shrink-0 flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-semibold whitespace-nowrap transition min-h-[40px] cursor-pointer ${
                isActive
