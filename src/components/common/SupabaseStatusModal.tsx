...
export const SupabaseStatusModal: React.FC<SupabaseStatusModalProps> = ({
  ...
  // Auto-verify connection when modal opens
  useEffect(() => {
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
                ...
                <div className="p-3 bg-slate-50 rounded-xl border border-slate-200/80">
                  ...
                  <span className="font-mono text-slate-800 truncate block">db.{syncStatus.projectId}.supabase.co:5432</span>
                </div>
                <div className="p-3 bg-slate-50 rounded-xl border border-slate-200/80">
                  <span className="text-slate-400 block text-[10px] font-semibold uppercase tracking-wider">
                    Database / User
                  </span>
                  <span className="font-mono text-slate-800 truncate block">postgres / postgres</span>
                </div>
              </div>

              {/* Live Record Counts */}
              <div className="grid grid-cols-3 gap-3">
                <div className="bg-emerald-50/60 border border-emerald-200/70 p-3 rounded-xl text-center">
                  <span className="text-emerald-800 block text-lg font-black">{syncStatus.tableCounts.bookings}</span>
                  <span className="text-[10px] text-emerald-700 font-semibold uppercase tracking-wider">Bookings</span>
                </div>
                <div className="bg-blue-50/60 border border-blue-200/70 p-3 rounded-xl text-center">
                  <span className="text-blue-800 block text-lg font-black">{syncStatus.tableCounts.users}</span>
                  <span className="text-[10px] text-blue-700 font-semibold uppercase tracking-wider">Users</span>
                </div>
                <div className="bg-indigo-50/60 border border-indigo-200/70 p-3 rounded-xl text-center">
                  <span className="text-indigo-800 block text-lg font-black">{syncStatus.tableCounts.workers}</span>
                  <span className="text-[10px] text-indigo-700 font-semibold uppercase tracking-wider">Workers</span>
                </div>
              </div>
